...
class Indeks extends Component
{
    ...
    public function simpan()
    {
        ...
        $this->catatAktivitas(
            'tambah',
            'Produk',
            "Berhasil menambahkan produk baru: {$produk->nama} dengan harga Rp ".number_format($produk->harga)
        );

        $this->dispatch('notifikasi', pesan: 'Produk berhasil ditambahkan!', tipe: 'sukses');
        $this->batal();
    }
