<div class="min-h-screen flex items-center justify-center bg-[#F1F5F9] relative overflow-hidden font-['Plus_Jakarta_Sans']">
    ...
    <div class="w-full max-w-md bg-white/80 backdrop-blur-2xl p-12 rounded-[3.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-white relative z-10 mx-4">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl font-['Outfit'] font-black text-slate-900 mb-2 tracking-tight uppercase italic leading-none">Akses <span class="text-blue-600 font-light">YalaCore</span></h2>
            <p class="text-slate-400 text-[10px] font-black tracking-[0.4em] uppercase mt-2">Pusat Keamanan Korporat</p>
        </div>

        <form wire:submit="masuk" class="space-y-8">
            <div class="group">
                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-2 group-focus-within:text-blue-600 transition-colors">Identitas Digital (Surel)</label>
                <div class="relative">
            ...
            <div class="group">
                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-2 group-focus-within:text-blue-600 transition-colors">Kunci Keamanan</label>
                <div class="relative">
            ...
            <div class="flex items-center justify-between px-2">
                <label class="flex items-center gap-3 cursor-pointer group">
                    ...
                    <span class="text-[10px] font-black text-slate-400 group-hover:text-slate-600 transition-colors uppercase tracking-widest">Tetap Masuk</span>
                </label>
                <a href="#" class="text-[10px] font-black text-blue-600 hover:text-blue-700 uppercase tracking-widest hover:underline decoration-2 underline-offset-4">Lupa Sandi?</a>
            </div>
            ...
            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-black py-5 rounded-2xl shadow-xl shadow-blue-200 transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-4 border-t border-white/20">
                ...
                <span class="text-xs uppercase tracking-[0.3em]">Masuk Sistem</span>
            </button>
        </form>
        ...
        <div class="mt-12 pt-10 border-t border-slate-100 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-50 border border-slate-100">
                ...
                <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Sistem v4.0.9 // Teramankan</p>
            </div>
        </div>
    </div>
</div>